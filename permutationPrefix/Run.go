...
func Setup() {
	cases := []struct {
		...
		{A: []int{2, 3, 1}, B: []int{3, 1, 2}, C: []int{0, 1, 3}},
		{A: []int{3, 2, 4, 1}, B: []int{1, 4, 3, 2}, C: []int{0, 0, 2, 4}},
		{A: []int{1, 2, 3, 4}, B: []int{5, 6, 7, 8}, C: []int{0, 0, 0, 0}},
		{A: []int{5, 1, 4, 8, 2, 9, 3, 6, 7}, B: []int{8, 3, 2, 4, 9, 7, 5, 1, 6}, C: []int{0, 0, 0, 2, 3, 4, 6, 7, 9}},
		{A: []int{6, 4, 8, 1, 2, 9, 3, 7, 5}, B: []int{2, 3, 7, 9, 8, 5, 1, 6, 4}, C: []int{0, 0, 0, 0, 2, 3, 5, 7, 9}},
		{A: []int{1, 2, 3, 4, 5, 9, 6, 7, 8}, B: []int{9, 10, 11, 12, 6, 13, 14, 15, 16}, C: []int{0, 0, 0, 0, 0, 1, 2, 2, 2}},
		{A: []int{}, B: []int{}, C: []int{}},
	}
